                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo "<a href='admin.php?delete=$user_id'>Delete</a>"; ?>
                                    </td>
                                    <td><?php echo "<a href='admin.php?source=update_user&user_id=$user_id'>Edit</a>"; ?></td>
                                    <td><?php echo "<a href='admin.php?remove_from_admin=$user_id'>Make Customer</a>"; ?>
                                    </td>
                                    <td><?php echo "<a href='admin.php?make_vender=$user_id'>Make Vender</a>"; ?>
                                    </td>
